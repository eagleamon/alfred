...
def parseArgs(sysArgs=''):
    ...
    group.add_argument('--db_host', help='Database server address (localhost)', default='localhost')
    ...
    group.add_argument('--client-path', help='Webclient app path ("./client/dist")', default='./client')
