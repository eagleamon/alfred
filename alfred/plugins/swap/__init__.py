...
# dependencies = {'pip': 'https://github.com/panStamp/panstamp/tree/master/python/pyswap',
#     'text': "Get pyswap from above link and install it by yourselves, hard from here.."}
